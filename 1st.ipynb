{
  ...
  "cells": [
    ...
    {
      "cell_type": "markdown",
      "source": "**(1) Predict price of a home with area = 3300 sqr ft**",
      "metadata": {}
    },
    {
      "cell_type": "code",
    ...
    {
      "cell_type": "markdown",
      "source": "**Y = m * X + b (m is coefficient and b is intercept)**",
      "metadata": {}
    },
    {
      "cell_type": "code",
      "source": "3300*135.78767123 + 180616.43835616432",
      "metadata": {
        "scrolled": true
      },
      "outputs": [
    ...
    {
      "cell_type": "markdown",
      "source": "**(1) Predict price of a home with area = 5000 sqr ft**",
      "metadata": {}
    },
    {
      "cell_type": "code",
    ...
    {
      "cell_type": "markdown",
      "source": "<h3 style=\"color:purple\">Generate CSV file with list of home price predictions</h3>",
      "metadata": {}
    },
    {
      "cell_type": "code",
